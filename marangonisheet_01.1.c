...
event init(i = 0)
{
    if (!restore(file = dumpFile))
    {
        foreach ()
        {
            d[] = 0.207801*pow(y, 0) + 0.059600*pow(y, 1) + 0.011949*pow(y, 2) + 0.000295*pow(y, 3) + -0.000615*pow(y, 4) + 0.000067*pow(y, 5) + -0.000002*pow(y, 6) + -0.000000*pow(y, 7) - x;
        }
        foreach ()
        {
            sigmaf[] = 1. + GammaR * (y);
